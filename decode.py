...
def decode_caesar(key, input_file, output_file):
    decode_vigener(string.ascii_lowercase[key], input_file, output_file)


def decode_vigener(key, input_file, output_file):
